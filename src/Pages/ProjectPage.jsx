            ...
            return (
                <div className="ProjectTrailerContainer">
                    ...
                    <div className="IFrameContainer">
                        <iframe class="IFrameVideo" src={this.props.currentSelectedProject.projectTrailerLink}
    ...
    render() {
        return (
            <div className="ProjectPage">
                <img className="ProjectPageImage"
                     src={this.props.currentSelectedProject.projectDirectory + "logo.jpg"}/>
